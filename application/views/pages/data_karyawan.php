<div class="container-fluid" id="container-wrapper">
  ...
  <!-- Modal Detail -->
  <div class="modal fade" id="view-karyawan" tabindex="-1" role="dialog" aria-labelledby="view-karyawan-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="view-karyawan-title"></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div id="view-karyawan-body" class="modal-body p-4">
        </div>
  ...
  <!-- Modal Edit Data -->
  <div class="modal fade" id="edit-karyawan" tabindex="-1" role="dialog" aria-labelledby="edit-karyawan-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="edit-karyawan-title">Edit Data Pelanggan</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form id="form-edit-karyawan">
          <div class="edit-karyawan-body p-4">
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="edit-karyawanname" placeholder="Masukkan Username">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6">
  ...
  <!-- Modal Tambah Data -->
  <div class="modal fade" id="tambah-karyawan" tabindex="-1" role="dialog" aria-labelledby="tambah-karyawan-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tambah-karyawan-title">Tambah Data Pelanggan</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form id="form-tambah-karyawan">
          <div class="tambah-karyawan-body p-4">
            <div class="form-row">
              <div class="form-group col-md-6">
...
<script>
  var url = '<?= base_url() . 'index.php/datakaryawan/' ?>';
  var id = null;
  ...
  $(document).ready(function() {
    ...
    $('#tambah-data').click(function() {
      $('#tambah-karyawan').modal('show');
    });

    //fungsi tombol detail
    $('#dataTable tbody').on('click', 'button#detail', function() {
      var data = table.row($(this).parents('tr')).data();
      $('#view-karyawan').modal('show');
      $('#view-karyawan-title').text('Detail untuk ' + data.name);
      $('#view-karyawan-body').html(`
      ...
      `);
      $('#view-karyawan-body table tr td:nth-child(1)').css({
        'background-color': '#D0ECE7',
        'padding': '4px',
        'border': '2px solid white'
      });
      $('#view-karyawan-body table tr td:nth-child(2)').css({
    ...
    $('#dataTable tbody').on('click', 'button#edit', function() {
      ...
      $('#edit-karyawan-title').text('Edit data ' + data.name);
    ...
    $('#simpan-tambah').click(function(e) {
      ...
      $.post({
        ...
        success: function(data) {
          ...
          $('#form-tambah-karyawan').trigger('reset');
          table.ajax.reload();
        }
      });
    });
